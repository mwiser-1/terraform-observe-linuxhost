...
This module registers metrics collected by the mem [input plugin](https://github.com/influxdata/telegraf/blob/master/plugins/inputs/mem/README.md)
...
module "telegraf_mem" {
  source       = "git@github.com:observeinc/terraform-observe-telegraf.git//inputs/mem"
  workspace    = data.observe_workspace.default
...
| observe_dataset.mem_metrics | resource |

| observe_link.mem_metrics | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_mem_metrics"></a> [mem\_metrics](#output\_mem\_metrics) | n/a |
