# Telegraf Kernel Input

This module registers metrics collected by the kernel [input plugin](https://github.com/influxdata/telegraf/blob/master/plugins/inputs/kernel/README.md)
...
module "telegraf_kernel" {
  source       = "git@github.com:observeinc/terraform-observe-telegraf.git//inputs/kernel"
  workspace    = data.observe_workspace.default
...
| observe_dataset.kernel_metrics | resource |

| observe_link.kernel_metrics | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_kernel_metrics"></a> [kernel\_metrics](#output\_kernel\_metrics) | n/a |
