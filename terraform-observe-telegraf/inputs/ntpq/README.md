...
This module registers metrics collected by the ntpq [input plugin](https://github.com/influxdata/telegraf/blob/master/plugins/inputs/ntpq/README.md)
...
module "telegraf_ntpq" {
  source       = "git@github.com:observeinc/terraform-observe-telegraf.git//inputs/ntpq"
  workspace    = data.observe_workspace.default
...
| observe_dataset.ntpq_metrics | resource |

| observe_link.ntpq_metrics | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_ntpq_metrics"></a> [ntpq\_metrics](#output\_ntpq\_metrics) | n/a |
