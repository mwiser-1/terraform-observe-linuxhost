# Telegraf Linux Sysctl FS Input

This module registers metrics collected by the linux_sysctl_fs [input plugin](https://github.com/influxdata/telegraf/blob/master/plugins/inputs/linux_sysctl_fs/README.md)
...
module "telegraf_linux_sysctl_fs" {
  source       = "git@github.com:observeinc/terraform-observe-telegraf.git//inputs/linux_sysctl_fs"
  workspace    = data.observe_workspace.default
...
| observe_dataset.linux_sysctl_fs_metrics | resource |

| observe_link.linux_sysctl_fs_metrics | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_linux_sysctl_fs_metrics"></a> [linux\_sysctl\_fs\_metrics](#output\_linux\_sysctl\_fs\_metrics) | n/a |
